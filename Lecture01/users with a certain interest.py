...
def main():
    ints = [(0, "Hadoop"), (0, "Big Data"), (0, "HBase"), (0,
    ...
    (5, "Java"), (5, "C++"), (5, "Haskell"), (5, "programming languages"), (6, "statistics"), (6, "probability"), (6,
    ...
    like1 = input("enter a intrest")
    print(like (ints, like1))
